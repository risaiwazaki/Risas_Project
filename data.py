def playdata():
    ...
    dob = "October 19"
    grade = "Junior"
    story = "As a coding beginner taking AP Computer Science Principles, I have learned so much. \"I have completed multple personal projects in my own repository that I am proud of.\"  Hopefully my coding becomes bettwe as I practice everyday."
    info = {"greeting": greeting, "name": name, "dob": dob, "grade": grade, "story": story}
    return info
...
def setup():
    #Source Data
    name = "Risa's Website"
    github = "https://github.com/risaiwazaki/Risas_Project"
